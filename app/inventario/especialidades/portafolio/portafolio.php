        ...
        <div class="modal-content">
            ...
            <form id="formulario">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nombreCategoria">Codigo portafolio</label>
                        <input type="text" class="form-control" id="Code" placeholder="" name="Code" required>
                    </div>
                    <div class="form-group">
                        <label for="nombreCategoria">Portafolio</label>
...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Gestión de portafolios</h4>
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "POST",
        url: "app/inventario/especialidades/portafolio/portafolioAcciones.php",
        data: {accion: 'Especialidad'},
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".btnEditar", function() {
            ...
            U_HBT_ESPECIALIDAD = $(this).closest("tr").find('td:eq(2)').text();
            $("#Code").val(Code);
            $("#Name").val(Name);
