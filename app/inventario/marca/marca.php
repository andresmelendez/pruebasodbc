...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Gestión de marcas</h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        tabla = $('#tablaMarcas').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "app/inventario/marca/marcaAcciones.php",
                "type": "POST",
                "data": {
                    "accion": 'Listar'
                }
        ...
        $(document).on("click", ".btnEditar", function() {
            accion = 'Modificar';
            FirmCode = $(this).closest("tr").find('td:eq(0)').text();
            FirmName = $(this).closest("tr").find('td:eq(1)').text();
        ...
        $(document).on("click", ".btnBorrar", function() {
            FirmCode = $(this).closest('tr').find('td:eq(0)').text();
            accion = 'Eliminar';
            var respuesta = confirm("¿Está seguro de borrar el registro con ID " + FirmCode + "?");
            if (respuesta) {
                $.ajax({
                    url: "app/inventario/marca/marcaAcciones.php",
                    type: "POST",
