        ...
        <div class="modal-content">
            ...
            <form id="formulario">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nombreCategoria">Codigo Categoria</label>
...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Gestión de categorias</h4>
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "POST",
        url: "app/inventario/categorias/categoria/categoriaAcciones.php",
        data: {
            accion: 'Linea'
        },
    ...
    function cargarGrupo(grupo = null) {
        $.ajax({
            type: "POST",
            url: "app/inventario/categorias/categoria/categoriaAcciones.php",
            data: {
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".btnEditar", function() {
            ...
            U_HBT_GRUPO = $(this).closest("tr").find('td:eq(2)').text();
            U_HBT_CODIGO = $(this).closest("tr").find('td:eq(4)').text();
            $("#Code").val(Code);
            $("#Name").val(Name);
            $("#U_HBT_CODIGO").val(U_HBT_CODIGO);
            cargarGrupo(U_HBT_GRUPO);
